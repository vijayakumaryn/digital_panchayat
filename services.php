...
<main>
  ...
  <div class="cards-container">
    <div class="card">
      ...
      <h3><a href="homebill.html" target="_blank">Home Tax</a></h3>
    </div>

    <div class="card">
      <i class="fas fa-file-invoice-dollar"></i>
      <h3><a href="https://bsk.karnataka.gov.in/BSK/cs/loadOnlineServicesBeforeLogin" target="_blank">House Tax Payment</a></h3>
    </div>

    <div class="card">
      <i class="fas fa-building"></i>
      <h3><a href="https://bsk.karnataka.gov.in/BSK/cs/loadOnlineServicesBeforeLogin" target="_blank">Vasati Yojane</a></h3>
    </div>
  </div>
